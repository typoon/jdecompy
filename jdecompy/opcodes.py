...
OPC[17] =  {'num_args': 1, 'num_bytes': 2, 'name' : 'sipush'}
OPC[18] =  {'num_args': 1, 'num_bytes': 1, 'name' : 'ldc'}
OPC[19] =  {'num_args': 1, 'num_bytes': 2, 'name' : 'ldc_w'}
OPC[20] =  {'num_args': 1, 'num_bytes': 2, 'name' : 'ldc2_w'}
OPC[21] =  {'num_args': 1, 'num_bytes': 1, 'name' : 'iload'}
OPC[22] =  {'num_args': 1, 'num_bytes': 1, 'name' : 'lload'}
OPC[23] =  {'num_args': 1, 'num_bytes': 1, 'name' : 'fload'}
OPC[24] =  {'num_args': 1, 'num_bytes': 1, 'name' : 'dload'}
OPC[25] =  {'num_args': 1, 'num_bytes': 1, 'name' : 'aload'}
